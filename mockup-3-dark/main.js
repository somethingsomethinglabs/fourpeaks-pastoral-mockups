/* Four Peaks Pastoral — Mockup3 dark mode (Soft Operational · blue↔white flip · Split · Inset) */
...
(function () {
  ...
  const LOGO_MARK = "images/logos/logo-wordmark-light.png";
  ...
  function syncHeaderState() {
    if (!header) return;
    /* Dark inset chrome — scrolled shadow only */
